...
class LineFormatterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDefFormatExtras()
    {
        ...
        $message = $formatter->format(array(
            ...
            'context' => array(),
            'datetime' => new \DateTime,
            'extra' => array('ip' => 'localhost'),
            'message' => 'log',
        ));
        $this->assertEquals('['.date('Y-m-d').'] meh.ERROR: log [] {"ip":"localhost"}'."\n", $message);
    }
    ...
    public function testFormatExtras()
    {
        ...
        $message = $formatter->format(array(
            ...
            'context' => array(),
            'datetime' => new \DateTime,
            'extra' => array('ip' => 'localhost', 'file' => 'test'),
            'message' => 'log',
        ));
        $this->assertEquals('['.date('Y-m-d').'] meh.ERROR: log [] test {"ip":"localhost"}'."\n", $message);
    }
