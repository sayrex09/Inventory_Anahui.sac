...
abstract class Swift_Transport_AbstractSmtpTransport implements Swift_Transport
{
     ...
     */
    public function __construct(Swift_Transport_IoBuffer $buf, Swift_Events_EventDispatcher $dispatcher, $localDomain = 'localhost', Swift_AddressEncoder $addressEncoder = null)
    {
        $this->buffer = $buf;
