...
class HttpCacheTest extends HttpCacheTestCase
{
    ...
    public function testClientIpIsAlwaysLocalhostForForwardedRequests()
    {
        ...
        $this->kernel->assert(function ($backendRequest) {
            $this->assertSame('localhost', $backendRequest->server->get('REMOTE_ADDR'));
        });
    }
    ...
    public function testHttpCacheIsSetAsATrustedProxy(array $existing)
    {
        ...
        $existing = array_unique(array_merge($existing, array('localhost')));
    ...
    public function getTrustedProxyData()
    {
        return array(
            ...
            array(array('10.0.0.2', 'localhost')),
        );
    }
    ...
    public function testUsesOriginalRequestForSurrogate()
    {
        ...
        $kernel
            ...
            ->willReturnCallback(function (Request $request) {
                $this->assertSame('localhost', $request->server->get('REMOTE_ADDR'));
