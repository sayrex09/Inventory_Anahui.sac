...
class InlineFragmentRendererTest extends TestCase
{
    ...
    public function testRenderWithObjectsAsAttributes()
    {
        ...
        $subRequest->headers->set('x-forwarded-for', array('localhost'));
        $subRequest->headers->set('forwarded', array('for="localhost";host="localhost";proto=http'));
        $subRequest->server->set('HTTP_X_FORWARDED_FOR', 'localhost');
        $subRequest->server->set('HTTP_FORWARDED', 'for="localhost";host="localhost";proto=http');
    ...
    public function testRenderWithTrustedHeaderDisabled()
    {
        ...
        $expectedSubRequest->headers->set('x-forwarded-for', array('localhost'));
        $expectedSubRequest->server->set('HTTP_X_FORWARDED_FOR', 'localhost');
    ...
    public function testLocaleAndFormatAreIsKeptInSubrequest()
    {
        ...
        $expectedSubRequest->headers->set('forwarded', array('for="localhost";host="localhost";proto=http'));
        $expectedSubRequest->server->set('HTTP_FORWARDED', 'for="localhost";host="localhost";proto=http');
    ...
    public function testFirstTrustedProxyIsSetAsRemote()
    {
        ...
        $expectedSubRequest = Request::create('/');
        $expectedSubRequest->headers->set('Surrogate-Capability', 'abc="ESI/1.0"');
        $expectedSubRequest->server->set('REMOTE_ADDR', 'localhost');
        $expectedSubRequest->headers->set('x-forwarded-for', array('localhost'));
        $expectedSubRequest->headers->set('forwarded', array('for="localhost";host="localhost";proto=http'));
        $expectedSubRequest->server->set('HTTP_X_FORWARDED_FOR', 'localhost');
        $expectedSubRequest->server->set('HTTP_FORWARDED', 'for="localhost";host="localhost";proto=http');
