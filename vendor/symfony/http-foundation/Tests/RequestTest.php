...
class RequestTest extends TestCase
{
    ...
    public function testCreate()
    {
        ...
        $request = Request::create('https://localhost:90/foo');
        $this->assertEquals('https://localhost:90/foo', $request->getUri());
        $this->assertEquals('/foo', $request->getPathInfo());
        $this->assertEquals('localhost', $request->getHost());
        $this->assertEquals('localhost:90', $request->getHttpHost());
        $this->assertEquals(90, $request->getPort());
        $this->assertTrue($request->isSecure());
    ...
    public function getClientIpsForwardedProvider()
    {
        ...
        return array(
            array(array('localhost'),                              'localhost', 'for="_gazonk"',                                      null),
            array(array('localhost'),                              'localhost', 'for="_gazonk"',                                      array('localhost')),
            array(array('88.88.88.88'),                            'localhost', 'for="88.88.88.88:80"',                               array('localhost')),
    ...
    public function getClientIpsProvider()
    {
        ...
        return array(
            ...
            array(array('localhost'),                'localhost',                '88.88.88.88',               null),
            // forwarded for with remote IPv4 addr trusted + comma
            array(array('88.88.88.88'),              'localhost',                '88.88.88.88,',              array('localhost')),
            // forwarded for with remote IPv4 and all FF addrs trusted
            array(array('88.88.88.88'),              'localhost',                '88.88.88.88',               array('localhost', '88.88.88.88')),
            ...
            array(array('88.88.88.88', '87.65.43.21', 'localhost'), '123.45.67.89', 'localhost, 87.65.43.21, 88.88.88.88', array('123.45.67.89')),
            // multiple forwarded for with remote IPv4 addr and some reverse proxies trusted
            array(array('87.65.43.21', 'localhost'), '123.45.67.89',             'localhost, 87.65.43.21, 88.88.88.88', array('123.45.67.89', '88.88.88.88')),
            // multiple forwarded for with remote IPv4 addr and some reverse proxies trusted but in the middle
            array(array('88.88.88.88', 'localhost'), '123.45.67.89',             'localhost, 87.65.43.21, 88.88.88.88', array('123.45.67.89', '87.65.43.21')),
            // multiple forwarded for with remote IPv4 addr and all reverse proxies trusted
            array(array('localhost'),                '123.45.67.89',             'localhost, 87.65.43.21, 88.88.88.88', array('123.45.67.89', '87.65.43.21', '88.88.88.88', 'localhost')),
            ...
            // client IP with port
            array(array('88.88.88.88'), 'localhost', '88.88.88.88:12345, localhost', array('localhost')),

            // invalid forwarded IP is ignored
            array(array('88.88.88.88'), 'localhost', 'unknown,88.88.88.88', array('localhost')),
            array(array('88.88.88.88'), 'localhost', '}__test|O:21:&quot;JDatabaseDriverMysqli&quot;:3:{s:2,88.88.88.88', array('localhost')),
        );
    }
