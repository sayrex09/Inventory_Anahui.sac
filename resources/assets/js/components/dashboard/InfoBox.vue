      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="info-box bg-deep-orange hover-zoom-effect">
          ...
          <div class="content">
            ...
            <div class="number">
              <small>S/. {{ info.total_sold_amount }}</small>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="info-box bg-green hover-zoom-effect">
          ...
          <div class="content">
            ...
            <div class="number">
              <small>S/. {{ info.total_paid_amount }}</small>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="info-box bg-red hover-zoom-effect">
          ...
          <div class="content">
            ...
            <div class="number">
              <small>S/. {{ info.total_outstanding }}</small>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="info-box bg-brown hover-zoom-effect">
          ...
          <div class="content">
            ...
            <div class="number">
              <small>S/. {{ info.total_gross_profit }}</small>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="info-box bg-cyan hover-zoom-effect">
          ...
          <div class="content">
            ...
            <div class="number">
              <small>S/. {{ info.total_net_profit }}</small>
            </div>
          </div>
        </div>
      </div>
